...
robot_id = p.loadURDF ("/home/aniruth/Desktop/RRC/XARM7/xArm-Python-SDK/example/wrapper/xarm7/Follow_DROID/Franka_arm/Droid Mask Extraction/lite-6/lite_6.urdf",[0, 0, 0], useFixedBase=True) # updated URDF
...
with open("./RLDS_Data/scene_4/cart_pos.txt", "r") as file:
    for line in file:
