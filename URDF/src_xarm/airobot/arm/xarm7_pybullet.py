...
class XARM7Pybullet(SingleArmPybullet):
    """
    ...
    def __init__(self,
                 ...
                 eetool_cfg=None):
        super(XARM7Pybullet, self).__init__(cfgs=cfgs,
                                           pb_client=pb_client,
                                           seed=seed,
    ...
    def set_visual_shape(self):
        """
        Set the color of the XARM7 arm. 
        Changeeeeeee ittt!!!!!!!!!!!!
        """
        color1 = [0.25, 0.25, 0.25, 1]
        color2 = [0.95, 0.95, 0.95, 1]
        color3 = [0.25, 0.25, 0.985, 1]
        jnt_id = self.jnt_to_id['joint1']
        self._pb.changeVisualShape(self.robot_id,
                                   jnt_id,
                                   rgbaColor=color1)
        self._pb.changeVisualShape(self.robot_id,
                                   self.jnt_to_id['joint2'],
                                   rgbaColor=color2)
        self._pb.changeVisualShape(self.robot_id,
                                   self.jnt_to_id['joint3'],
                                   rgbaColor=color1)
        self._pb.changeVisualShape(self.robot_id,
                                   self.jnt_to_id['joint4'],
                                   rgbaColor=color2)
        self._pb.changeVisualShape(self.robot_id,
                                   self.jnt_to_id['joint5'],
                                   rgbaColor=color1)
        self._pb.changeVisualShape(self.robot_id,
                                   self.jnt_to_id['joint6'],
                                   rgbaColor=color2)
        self._pb.changeVisualShape(self.robot_id,
                                   self.jnt_to_id['joint7'],
                                   rgbaColor=color1)
        
        # print("hereeeeeeeeee--------- ", self.link_to_id)
        # link_id = self.link_to_id['link1']
        # self._pb.changeVisualShape(self.robot_id,
        #                            link_id,
        #                            rgbaColor=color3)
        # self._pb.changeVisualShape(self.robot_id,
        #                            self.link_to_id['link2'],
        #                            rgbaColor=color3)
        # self._pb.changeVisualShape(self.robot_id,
        #                            self.link_to_id['link3'],
        #                            rgbaColor=color3)
        # self._pb.changeVisualShape(self.robot_id,
        #                            self.link_to_id['link4'],
        #                            rgbaColor=color3)
        # self._pb.changeVisualShape(self.robot_id,
        #                            self.link_to_id['link5'],
        #                            rgbaColor=color3)
        # self._pb.changeVisualShape(self.robot_id,
        #                            self.link_to_id['link6'],
        #                            rgbaColor=color3)
        # self._pb.changeVisualShape(self.robot_id,
        #                            self.link_to_id['link7'],
        #                            rgbaColor=color3)
