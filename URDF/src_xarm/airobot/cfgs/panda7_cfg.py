...
from airobot.cfgs.assets.panda7_gripper import get_panda7gripper_cfg
from airobot.cfgs.assets.panda7_arm import get_panda7_arm_cfg
...
_C.PYBULLET_URDF = 'panda_with_gripper.urdf'

_C.ARM = get_panda7_arm_cfg()

_C.CAM.SIM = get_sim_cam_cfg()
_C.CAM.REAL = get_realsense_cam_cfg()
_C.CAM.CLASS = 'RGBDCamera'

_C.EETOOL = get_panda7gripper_cfg()
_C.EETOOL.CLASS = 'Panda7Gripper'
