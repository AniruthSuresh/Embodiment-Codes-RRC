...
class Panda7GripperPybullet(SimpleGripperPybullet):
    """
    ...
    def __init__(self, cfgs, pb_client):
        super(Panda7GripperPybullet, self).__init__(cfgs=cfgs,
                                                    pb_client=pb_client)
    ...
    def feed_robot_info(self, robot_id, jnt_to_id):
        ...
        """
        super(Panda7GripperPybullet, self).feed_robot_info(robot_id, jnt_to_id)
        self._setup_gripper()
