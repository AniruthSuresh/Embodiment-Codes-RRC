...
class XARM7GripperPybullet(SimpleGripperPybullet):
    """
    ...
    def __init__(self, cfgs, pb_client):
        super(XARM7GripperPybullet, self).__init__(cfgs=cfgs,
                                                    pb_client=pb_client)
    ...
    def _setup_gripper(self):
        ...
        self._pb.changeDynamics(self.robot_id,
                                self.jnt_to_id['left_finger_joint'],
                                lateralFriction=2.0,
                                spinningFriction=1.0,
                                rollingFriction=1.0)
        self._pb.changeDynamics(self.robot_id,
                                self.jnt_to_id['right_finger_joint'],
                                lateralFriction=2.0,
                                spinningFriction=1.0,
                                rollingFriction=1.0)
