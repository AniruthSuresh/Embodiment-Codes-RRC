...
# Command to run : tfds build xarm_sim_dataset --data_dir=~/tfds_data --overwrite
class xArmSimDataset(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for xArm simulation dataset."""
